...
# UNIX code
#/cygdrive/c/Users/Lucky/Documents/Hospital_data/04_2017_DOWNLOAD/pat_pdfs
...
act_pdf <- fread("c:/Users/Lucky/Documents/Hospital_data/04_2017_DOWNLOAD/pat_pdfs/all_pdf_count.txt",
                 header=FALSE)
...
# UNIX code
#/cygdrive/c/Users/Lucky/Documents/Hospital_data/04_2017_DOWNLOAD/pat_txts
...
act_txt <- fread("c:/Users/Lucky/Documents/Hospital_data/04_2017_DOWNLOAD/pat_txts/all_txt_count.txt",
                 header=FALSE)
...
mod_txt <- fread("c:/Users/Lucky/Documents/Hospital_data/04_2017_DOWNLOAD/pat_txts_mod/all_txt_mod_count.txt",
                 header=FALSE)
...
# Read the actual number of modified TXT files
# UNIX code
# /cygdrive/c/Users/Lucky/Documents/Hospital_data/04_2017_DOWNLOAD/emrurl
# find . -name "MR*.txt" -type f |xargs ls -lR --full-time > all_urls.txt

emrurl <- fread("c:/Users/Lucky/Documents/Hospital_data/04_2017_DOWNLOAD/emrurl/all_urls.txt",
                 header=FALSE)
